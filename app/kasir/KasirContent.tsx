            ...
            <div className="min-h-screen flex items-center justify-center bg-slate-950 overflow-hidden relative">
                ...
                <div className="relative flex flex-col items-center">
                    ...
                    <div className="mt-12 text-center space-y-2">
                        ...
                        <p className="text-[10px] font-black text-slate-500 uppercase tracking-[0.5em] ml-1">Menyiapkan Panel Kasir</p>
                    </div>
                </div>
            </div>
        )
        ...
        <div className="min-h-screen bg-slate-950 text-slate-200 transition-colors">
            ...
            <header className={`fixed top-0 right-0 h-16 bg-slate-900 border-b border-slate-800 z-30 flex items-center justify-between px-6 shadow-lg transition-all duration-300 ${isCollapsed ? 'left-20' : 'left-64'}`}>
                ...
                <div className="flex items-center gap-4">
                    <button className="p-2 hover:bg-slate-800 text-slate-400 hover:text-white rounded-full transition relative">
                        <Bell size={20} />
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-bold text-white hidden md:block">Kasir</span>
                    </div>
                </div>
            </header>
            ...
            >
                ...
                <div className={`h-16 flex items-center ${isCollapsed ? 'justify-center' : 'px-5 gap-3'} border-b border-slate-800 bg-slate-900`}>
                    ...
                    {!isCollapsed && (
                        <div className="animate-in fade-in duration-300">
                            ...
                            <p className="text-[9px] text-slate-500 font-bold uppercase tracking-widest mt-0.5">Kasir Panel</p>
                        </div>
                    )}
                </div>
                ...
                <nav className="flex-1 p-2 space-y-1.5 overflow-y-auto scrollbar-hide mt-3">
                    {!isCollapsed && <div className="text-[10px] font-black text-slate-600 uppercase px-4 mb-2 tracking-wider animate-in fade-in">Aplikasi</div>}
                    {menuItems.map((item) => {
