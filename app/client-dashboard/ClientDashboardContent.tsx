                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3 pl-3 border-l border-slate-200 dark:border-slate-700">
                        ...
                        <div className="hidden md:block">
                            <p className="text-sm font-bold text-slate-800 dark:text-slate-200">{session?.user?.name}</p>
                            <p className="text-xs text-slate-400 dark:text-slate-500">Pelanggan</p>
                        </div>
                    </div>
                </div>
            </header>
                ...
                <div className={`h-16 flex items-center ${isCollapsed ? 'justify-center' : 'px-5 gap-3'} border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800`}>
                    ...
                    {!isCollapsed && (
                        <div className="animate-in fade-in duration-300">
                            ...
                            <p className="text-[9px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest mt-0.5">Client Panel</p>
                        </div>
                    )}
                </div>
