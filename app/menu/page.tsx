                    ...
                    <div className="w-full lg:w-1/5 flex flex-row lg:flex-col gap-3 overflow-x-auto pb-4 lg:pb-0 scrollbar-hide shrink-0 sticky top-24 z-10">
                        {categories.map(cat => (
                            <button
                                ...
                                className={`flex items-center gap-3 px-4 py-3 rounded-xl border-2 transition-all font-bold text-sm whitespace-nowrap ${activeCategory === cat.id
                        ...
                        {loading ? <div className="text-center py-20 text-slate-400 font-bold">Sedang memuat menu lezat...</div> : (
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                                {filteredMenus.map(menu => (
                                    <div key={menu.id} className="bg-white rounded-2xl p-4 flex flex-col shadow-sm hover:shadow-xl hover:scale-[1.02] transition duration-300 group border border-slate-100">

                                        {/* Gambar Produk (Rounded Box) */}
                                        <div className="relative w-full h-48 bg-slate-100 rounded-xl overflow-hidden mb-4 shadow-inner border border-slate-100">
                                            {menu.image ? (
                                        ...
                                        <div className="flex-1 flex flex-col">
                                            <div className="flex justify-between items-start mb-1">
                                                <h3 className="font-bold text-lg text-slate-800 leading-tight uppercase tracking-wide">{menu.name}</h3>
                                            </div>
                                            ...
                                            <div className="mt-auto pt-3 border-t border-slate-100 flex justify-between items-center">
                                                ...
                                                <button
                                                    ...
                                                    className="bg-blue-600 text-white w-10 h-10 rounded-full flex items-center justify-center hover:bg-blue-700 transition shadow-lg shadow-blue-200 disabled:bg-slate-300 disabled:text-slate-500 disabled:shadow-none"
                                                >
