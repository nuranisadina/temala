  ...
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          <div>
              <h2 className="text-3xl font-black text-slate-800 uppercase">Manajemen Promo</h2>
          ...
          {promos.length === 0 ? (
              ...
              <table className="w-full text-left border-collapse">
                  <thead className="bg-slate-50 border-b border-slate-200">
                      <tr>
                          <th className="p-5 text-xs font-bold text-slate-500 uppercase">Banner</th>
                          <th className="p-5 text-xs font-bold text-slate-500 uppercase">Judul</th>
                      ...
                      {promos.map((item) => (
                          <tr key={item.id} className="hover:bg-slate-50 transition">
                              <td className="p-5 w-48">
                                  <div className="h-24 w-40 bg-slate-200 rounded-lg overflow-hidden relative border border-slate-200 shadow-sm">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 animate-in fade-in">
            <div className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in zoom-in-95">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    <div>
                        <label className="block text-xs font-bold text-slate-500 uppercase mb-1.5">Judul Promo</label>
                    ...
                    <div>
                        <label className="block text-xs font-bold text-slate-500 uppercase mb-1.5">Harga Promo (Rp)</label>
                    ...
                    <div>
                        <label className="block text-xs font-bold text-slate-500 uppercase mb-1.5">Banner Promo</label>
