  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
          <div>
              <h2 className="text-3xl font-black text-slate-800 uppercase tracking-tight">Manajemen Menu</h2>
              <p className="text-slate-500 text-sm mt-1">Kelola daftar makanan & minuman yang tersedia.</p>
          </div>
          <button 
